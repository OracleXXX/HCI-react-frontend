                    ...
                    <FooterMain>
                        <FooterNav>
                            <div className="nav-items-footer">
                                <Link to={router.index.path}>
                                    <div className="nav-title-footer pointer">网站导航</div>
                                </Link>
                                <Link to={router.new_project.path}>
                                    <div className='nav-item-footer pointer'>{router.new_project.name}</div>
                                </Link>
                                <Link to={router.one_step.path + router.management.path}>
                                    <div className='nav-item-footer pointer'>{router.management.name}</div>
                                </Link>
                                <Link to={router.one_step.path + router.long_short.path}>
                                    <div className='nav-item-footer pointer'>{router.long_short.name}</div>
                                </Link>
                                <Link to={router.platform_loan.path}>
                                    <div className='nav-item-footer pointer'>{router.platform_loan.name}</div>
                                </Link>
                            </div>
                        </FooterNav>
                        ...
                        <FooterContactUs>
                            <div className="nav-items-footer">
                                <Link to={router.contact_us.path}>
                                    <div className="nav-title-footer pointer">{router.contact_us.name}</div>
                                </Link>
                        ...
                        <PopularCities>
                            <div className="nav-items-footer two-columns">
                                <div className="col-left">
                                    ...
                                    <a href="https://zh.wikipedia.org/wiki/%E7%BA%B3%E4%BB%80%E7%BB%B4%E5%B0%94">
